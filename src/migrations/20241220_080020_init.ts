...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_home_social_links\` (
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_home_social_links_order_idx\` ON \`pages_blocks_home_social_links\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_home_social_links_parent_id_idx\` ON \`pages_blocks_home_social_links\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_home_profile_picture_idx\` ON \`pages_blocks_home\` (\`profile_picture_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_stacks_technologies_tech_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`color\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_technologies_tech_stacks_order_idx\` ON \`pages_blocks_stacks_technologies_tech_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_technologies_tech_stacks_parent_id_idx\` ON \`pages_blocks_stacks_technologies_tech_stacks\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_technologies_tech_stacks_tech_image_idx\` ON \`pages_blocks_stacks_technologies_tech_stacks\` (\`tech_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_stacks_technologies\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`tech_heading\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_technologies_order_idx\` ON \`pages_blocks_stacks_technologies\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_technologies_parent_id_idx\` ON \`pages_blocks_stacks_technologies\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_order_idx\` ON \`pages_blocks_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_parent_id_idx\` ON \`pages_blocks_stacks\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_stacks_path_idx\` ON \`pages_blocks_stacks\` (\`_path\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_about_details_details_points\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`detail_point\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_details_details_points_order_idx\` ON \`pages_blocks_about_details_details_points\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_details_details_points_parent_id_idx\` ON \`pages_blocks_about_details_details_points\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_about_details\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`details_title\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_details_order_idx\` ON \`pages_blocks_about_details\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_details_parent_id_idx\` ON \`pages_blocks_about_details\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_about_code_profiles_code_profile\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_code_profiles_code_profile_order_idx\` ON \`pages_blocks_about_code_profiles_code_profile\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_code_profiles_code_profile_parent_id_idx\` ON \`pages_blocks_about_code_profiles_code_profile\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_code_profiles_code_profile_code_profile_image_idx\` ON \`pages_blocks_about_code_profiles_code_profile\` (\`code_profile_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_about_code_profiles\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`heading\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_code_profiles_order_idx\` ON \`pages_blocks_about_code_profiles\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_code_profiles_parent_id_idx\` ON \`pages_blocks_about_code_profiles\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_about_profile_image_idx\` ON \`pages_blocks_about\` (\`profile_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_experience_experiences_about_your_work\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_about_your_work_order_idx\` ON \`pages_blocks_experience_experiences_about_your_work\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_about_your_work_parent_id_idx\` ON \`pages_blocks_experience_experiences_about_your_work\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_experience_experiences_tech_stack\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_tech_stack_order_idx\` ON \`pages_blocks_experience_experiences_tech_stack\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_tech_stack_parent_id_idx\` ON \`pages_blocks_experience_experiences_tech_stack\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_experience_experiences\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`designation\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_order_idx\` ON \`pages_blocks_experience_experiences\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_parent_id_idx\` ON \`pages_blocks_experience_experiences\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_experiences_company_logo_idx\` ON \`pages_blocks_experience_experiences\` (\`company_logo_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_experience_achievements\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`achievement\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_achievements_order_idx\` ON \`pages_blocks_experience_achievements\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_achievements_parent_id_idx\` ON \`pages_blocks_experience_achievements\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_experience\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_order_idx\` ON \`pages_blocks_experience\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_parent_id_idx\` ON \`pages_blocks_experience\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_experience_path_idx\` ON \`pages_blocks_experience\` (\`_path\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`pages_blocks_contact_contact_reasons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`reason\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_contact_contact_reasons_order_idx\` ON \`pages_blocks_contact_contact_reasons\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`pages_blocks_contact_contact_reasons_parent_id_idx\` ON \`pages_blocks_contact_contact_reasons\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_home_social_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`social_icon\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_home_social_links_order_idx\` ON \`_pages_v_blocks_home_social_links\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_home_social_links_parent_id_idx\` ON \`_pages_v_blocks_home_social_links\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_home_profile_picture_idx\` ON \`_pages_v_blocks_home\` (\`profile_picture_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_stacks_technologies_tech_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`color\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_technologies_tech_stacks_order_idx\` ON \`_pages_v_blocks_stacks_technologies_tech_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_technologies_tech_stacks_parent_id_idx\` ON \`_pages_v_blocks_stacks_technologies_tech_stacks\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_technologies_tech_stacks_tech_image_idx\` ON \`_pages_v_blocks_stacks_technologies_tech_stacks\` (\`tech_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_stacks_technologies\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`tech_heading\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_technologies_order_idx\` ON \`_pages_v_blocks_stacks_technologies\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_technologies_parent_id_idx\` ON \`_pages_v_blocks_stacks_technologies\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_order_idx\` ON \`_pages_v_blocks_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_parent_id_idx\` ON \`_pages_v_blocks_stacks\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_stacks_path_idx\` ON \`_pages_v_blocks_stacks\` (\`_path\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_about_details_details_points\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`detail_point\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_details_details_points_order_idx\` ON \`_pages_v_blocks_about_details_details_points\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_details_details_points_parent_id_idx\` ON \`_pages_v_blocks_about_details_details_points\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_about_details\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`details_title\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_details_order_idx\` ON \`_pages_v_blocks_about_details\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_details_parent_id_idx\` ON \`_pages_v_blocks_about_details\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_about_code_profiles_code_profile\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`code_profile_title\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_code_profiles_code_profile_order_idx\` ON \`_pages_v_blocks_about_code_profiles_code_profile\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_code_profiles_code_profile_parent_id_idx\` ON \`_pages_v_blocks_about_code_profiles_code_profile\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_code_profiles_code_profile_code_profile_image_idx\` ON \`_pages_v_blocks_about_code_profiles_code_profile\` (\`code_profile_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_about_code_profiles\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`heading\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_code_profiles_order_idx\` ON \`_pages_v_blocks_about_code_profiles\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_code_profiles_parent_id_idx\` ON \`_pages_v_blocks_about_code_profiles\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_about_profile_image_idx\` ON \`_pages_v_blocks_about\` (\`profile_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_experience_experiences_about_your_work\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`work_description\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_about_your_work_order_idx\` ON \`_pages_v_blocks_experience_experiences_about_your_work\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_about_your_work_parent_id_idx\` ON \`_pages_v_blocks_experience_experiences_about_your_work\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_experience_experiences_tech_stack\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`tech_stack_name\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_tech_stack_order_idx\` ON \`_pages_v_blocks_experience_experiences_tech_stack\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_tech_stack_parent_id_idx\` ON \`_pages_v_blocks_experience_experiences_tech_stack\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_experience_experiences\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`designation\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_order_idx\` ON \`_pages_v_blocks_experience_experiences\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_parent_id_idx\` ON \`_pages_v_blocks_experience_experiences\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_experiences_company_logo_idx\` ON \`_pages_v_blocks_experience_experiences\` (\`company_logo_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_experience_achievements\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`achievement\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_achievements_order_idx\` ON \`_pages_v_blocks_experience_achievements\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_achievements_parent_id_idx\` ON \`_pages_v_blocks_experience_achievements\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_experience\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_order_idx\` ON \`_pages_v_blocks_experience\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_parent_id_idx\` ON \`_pages_v_blocks_experience\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_experience_path_idx\` ON \`_pages_v_blocks_experience\` (\`_path\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_pages_v_blocks_contact_contact_reasons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`reason\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_contact_contact_reasons_order_idx\` ON \`_pages_v_blocks_contact_contact_reasons\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_pages_v_blocks_contact_contact_reasons_parent_id_idx\` ON \`_pages_v_blocks_contact_contact_reasons\` (\`_parent_id\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE TABLE \`projects_project_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_project_links_order_idx\` ON \`projects_project_links\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_project_links_parent_id_idx\` ON \`projects_project_links\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_project_links_service_icon_idx\` ON \`projects_project_links\` (\`service_icon_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`projects_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`feature\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_features_order_idx\` ON \`projects_features\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_features_parent_id_idx\` ON \`projects_features\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`projects_tech_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`tech_stack\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_tech_stacks_order_idx\` ON \`projects_tech_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_tech_stacks_parent_id_idx\` ON \`projects_tech_stacks\` (\`_parent_id\`);`)
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_project_image_idx\` ON \`projects\` (\`project_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects_slug_idx\` ON \`projects\` (\`slug\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`projects__status_idx\` ON \`projects\` (\`_status\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_projects_v_version_project_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`service_icon_id\` integer,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_project_links_order_idx\` ON \`_projects_v_version_project_links\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_project_links_parent_id_idx\` ON \`_projects_v_version_project_links\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_project_links_service_icon_idx\` ON \`_projects_v_version_project_links\` (\`service_icon_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_projects_v_version_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`feature\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_features_order_idx\` ON \`_projects_v_version_features\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_features_parent_id_idx\` ON \`_projects_v_version_features\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_projects_v_version_tech_stacks\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`tech_stack\` text,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_tech_stacks_order_idx\` ON \`_projects_v_version_tech_stacks\` (\`_order\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_tech_stacks_parent_id_idx\` ON \`_projects_v_version_tech_stacks\` (\`_parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE TABLE \`_projects_v\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`parent_id\` integer,
  ...
  `)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_parent_idx\` ON \`_projects_v\` (\`parent_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_version_project_image_idx\` ON \`_projects_v\` (\`version_project_image_id\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_version_slug_idx\` ON \`_projects_v\` (\`version_slug\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_version_updated_at_idx\` ON \`_projects_v\` (\`version_updated_at\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_version_created_at_idx\` ON \`_projects_v\` (\`version_created_at\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_version_version__status_idx\` ON \`_projects_v\` (\`version__status\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_created_at_idx\` ON \`_projects_v\` (\`created_at\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_updated_at_idx\` ON \`_projects_v\` (\`updated_at\`);`)
  await payload.db.drizzle.run(sql`CREATE INDEX \`_projects_v_latest_idx\` ON \`_projects_v\` (\`latest\`);`)
  ...
  await payload.db.drizzle.run(sql`CREATE INDEX \`payload_locked_documents_rels_projects_id_idx\` ON \`payload_locked_documents_rels\` (\`projects_id\`);`)
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_home_social_links\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_home\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_stacks_technologies_tech_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_stacks_technologies\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_about_details_details_points\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_about_details\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_about_code_profiles_code_profile\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_about_code_profiles\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_about\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_experience_experiences_about_your_work\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_experience_experiences_tech_stack\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_experience_experiences\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_experience_achievements\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_experience\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`pages_blocks_contact_contact_reasons\`;`)
  ...
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_home_social_links\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_home\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_stacks_technologies_tech_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_stacks_technologies\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_about_details_details_points\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_about_details\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_about_code_profiles_code_profile\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_about_code_profiles\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_about\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_experience_experiences_about_your_work\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_experience_experiences_tech_stack\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_experience_experiences\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_experience_achievements\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_experience\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_pages_v_blocks_contact_contact_reasons\`;`)
  ...
  await payload.db.drizzle.run(sql`DROP TABLE \`projects_project_links\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`projects_features\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`projects_tech_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`projects\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_projects_v_version_project_links\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_projects_v_version_features\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_projects_v_version_tech_stacks\`;`)
  await payload.db.drizzle.run(sql`DROP TABLE \`_projects_v\`;`)
